    ...
    return (
        <div className='w-full bg-[#f1f2f3]'>
            <div className='flex flex-col justify-center items-center py-2'>
                <form action="" onSubmit={handleSubmit} className='flex flex-col md:w-[50%] xl:w-[30%] w-[80%] my-2 bg-white shadow-md p-6 rounded'>
                    <ToastContainer />
                    <h4 className='text-xl py-1 text-center text-gray-900 font-serif'>Sign Up Form</h4>
                    ...
                    <input type="password" value={credentials.cpassword} onChange={onChange} className='px-1 py-1 mb-1 border-[1px] border-gray-900 rounded outline-none' name="cpassword" id="cpassword" placeholder='Enter your confirm password' minLength={6} />
                ...
                <p className='text-gray-900 my-2  font-sans'>already have an account? <Link to='/login' className='text-[#007ac6] underline tracking-tighter'>Login</Link> </p>
            </div>
        </div>
    )
}
